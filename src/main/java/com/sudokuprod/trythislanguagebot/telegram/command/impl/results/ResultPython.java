...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.PYTHON_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultPython extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), PYTHON_RESULT));
