...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.TYPESCRIPT_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultTypeScript extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), TYPESCRIPT_RESULT));
