...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.EIGHTH_QUESTION;

@Slf4j
@Component
@RequiredArgsConstructor
public class EighthStep extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        final String[][] buttons = new String[][]{{"Мама", "call29"},
                {"Папа", "call30"}, {"Выбрать кого-то одного?", "call31"}, {"Я не стану выбирать между ними", "call32"}};
        ...
        bot.execute(responseCreator.createPhoto(message.getChatId(), "static/images/8.jpg",
                EIGHTH_QUESTION, keyboardBuilder.createInlineKeyboard(keyboard)));
