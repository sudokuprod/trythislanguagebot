...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.SECOND_QUESTION;

@Slf4j
@Component
@RequiredArgsConstructor
public class SecondStep extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        final String[][] buttons = new String[][]{{"Ручками, ручками", "call5"},
                {"Трактор, так трактор", "call6"}, {"Не поеду я пахать поле", "call7"}};
        ...
        bot.execute(responseCreator.createPhoto(message.getChatId(), "static/images/2.jpg",
                SECOND_QUESTION, keyboardBuilder.createInlineKeyboard(keyboard)));
