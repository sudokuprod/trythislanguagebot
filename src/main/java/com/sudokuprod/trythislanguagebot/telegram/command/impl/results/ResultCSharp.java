...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.CSHARP_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultCSharp extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), CSHARP_RESULT));
