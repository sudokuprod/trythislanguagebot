...
import static com.sudokuprod.trythislanguagebot.telegram.state.State.RESULT_C_PLUS_PLUS;
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.CPLUSPLUS_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultCPlusPlus extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), CPLUSPLUS_RESULT));
