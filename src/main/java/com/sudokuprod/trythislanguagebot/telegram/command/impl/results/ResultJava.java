...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.JAVA_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultJava extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), JAVA_RESULT));
