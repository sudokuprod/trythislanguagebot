...
import static com.sudokuprod.trythislanguagebot.telegram.utils.ConstantText.KOTLIN_RESULT;

@Slf4j
@Component
@RequiredArgsConstructor
public class ResultKotlin extends ParentByStepAndResult {
    ...
    public void execute(@NonNull final TelegramLongPollingBot bot,
        ...
        bot.execute(responseCreator.createMessage(message.getChatId(), KOTLIN_RESULT));
